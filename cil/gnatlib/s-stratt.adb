...
--  This is the .NET-specific version of the body of System.Stream_Attributes
...
package body System.Stream_Attributes is
   ...
   pragma Import (CIL, From_C, "mgnat.adalib.Prim_Conversions.From_C");

   function From_F   (From : Float) return S_F;
   pragma Import (CIL, From_F, "mgnat.adalib.Prim_Conversions.From_F");

   function From_I   (From : Integer) return S_I;
   pragma Import (CIL, From_I, "mgnat.adalib.Prim_Conversions.From_I");

   function From_LF  (From : Long_Float) return S_LF;
   pragma Import (CIL, From_LF, "mgnat.adalib.Prim_Conversions.From_LF");

   function From_LI  (From : Long_Integer) return S_LI;
   pragma Import (CIL, From_LI, "mgnat.adalib.Prim_Conversions.From_LI");

   --  function From_LLF (From : Long_Long_Float) return S_LLF;
   --  pragma Import (CIL, From_LLF, "mgnat.adalib.Prim_Conversions.From_LF");

   --  function From_LLI (From : Long_Long_Integer) return S_LLI;
   --  pragma Import (CIL, From_LLI, "mgnat.adalib.Prim_Conversions.From_LI");

   function From_LLU (From : UST.Long_Long_Unsigned) return S_LLU;
   pragma Import (CIL, From_LLU, "mgnat.adalib.Prim_Conversions.From_LI");

   function From_LU  (From : UST.Long_Unsigned) return S_LU;
   pragma Import (CIL, From_LU, "mgnat.adalib.Prim_Conversions.From_LI");

   function From_SF  (From : Short_Float) return S_SF;
   pragma Import (CIL, From_SF, "mgnat.adalib.Prim_Conversions.From_F");

   --  function From_SI  (From : Short_Integer) return S_SI;
   --  pragma Import (CIL, From_SI, "mgnat.adalib.Prim_Conversions.From_SI");

   function From_SSI (From : Short_Short_Integer) return S_SSI;
   pragma Import (CIL, From_SSI, "mgnat.adalib.Prim_Conversions.From_B");

   function From_SSU (From : UST.Short_Short_Unsigned) return S_SSU;
   pragma Import (CIL, From_SSU, "mgnat.adalib.Prim_Conversions.From_B");

   function From_SU  (From : UST.Short_Unsigned) return S_SU;
   pragma Import (CIL, From_SU, "mgnat.adalib.Prim_Conversions.From_I");
   --  pragma Import (CIL, From_SU, "mgnat.adalib.Prim_Conversions.From_SI");

   function From_U   (From : UST.Unsigned) return S_U;
   pragma Import (CIL, From_U, "mgnat.adalib.Prim_Conversions.From_I");

   function From_WC  (From : Wide_Character) return S_WC;
   pragma Import (CIL, From_WC, "mgnat.adalib.Prim_Conversions.From_WC");
   ...
   pragma Import (CIL, To_C, "mgnat.adalib.Prim_Conversions.To_C");

   function To_F   (From : S_F) return Float;
   pragma Import (CIL, To_F, "mgnat.adalib.Prim_Conversions.To_F");

   function To_I   (From : S_I) return Integer;
   pragma Import (CIL, To_I, "mgnat.adalib.Prim_Conversions.To_I");

   function To_LF  (From : S_LF) return Long_Float;
   pragma Import (CIL, To_LF, "mgnat.adalib.Prim_Conversions.To_LF");

   function To_LI  (From : S_LI) return Long_Integer;
   pragma Import (CIL, To_LI, "mgnat.adalib.Prim_Conversions.To_LI");

   function To_LLF (From : S_LLF) return Long_Long_Float;
   pragma Import (CIL, To_LLF, "mgnat.adalib.Prim_Conversions.To_LF");

   function To_LLI (From : S_LLI) return Long_Long_Integer;
   pragma Import (CIL, To_LLI, "mgnat.adalib.Prim_Conversions.To_LI");

   function To_LLU (From : S_LLU) return UST.Long_Long_Unsigned;
   pragma Import (CIL, To_LLU, "mgnat.adalib.Prim_Conversions.To_LU");

   function To_LU  (From : S_LU) return UST.Long_Unsigned;
   pragma Import (CIL, To_LU, "mgnat.adalib.Prim_Conversions.To_LU");

   function To_SF  (From : S_SF) return Short_Float;
   pragma Import (CIL, To_SF, "mgnat.adalib.Prim_Conversions.To_F");

   --  function To_SI  (From : S_SI) return Short_Integer;
   --  pragma Import (CIL, To_SI, "mgnat.adalib.Prim_Conversions.To_I");
   --  pragma Import (CIL, To_SI, "mgnat.adalib.Prim_Conversions.To_SI");

   function To_SSI (From : S_SSI) return Short_Short_Integer;
   pragma Import (CIL, To_SSI, "mgnat.adalib.Prim_Conversions.To_B");

   function To_SSU (From : S_SSU) return UST.Short_Short_Unsigned;
   pragma Import (CIL, To_SSU, "mgnat.adalib.Prim_Conversions.To_BU");

   function To_SU  (From : S_SU) return UST.Short_Unsigned;
   pragma Import (CIL, To_SU, "mgnat.adalib.Prim_Conversions.To_U");
   --  pragma Import (CIL, To_SU, "mgnat.adalib.Prim_Conversions.To_SI");

   function To_U (From : S_U) return UST.Unsigned;
   pragma Import (CIL, To_U, "mgnat.adalib.Prim_Conversions.To_U");

   function To_WC  (From : S_WC) return Wide_Character;
   pragma Import (CIL, To_WC, "mgnat.adalib.Prim_Conversions.To_WC");
