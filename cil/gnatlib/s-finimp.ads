...
package System.Finalization_Implementation is
   ...
   --  attachment, 1 for simple linked lists or 2 for doubly linked lists
   --  or even 3 for a simple attachment of a whole array of elements.
   --  Attachment to a simply linked list is not protected against
   ...
   --  Generic attachment for tagged objects with controlled components. A
...
private
   CFS : aliased SFR.Root_Controlled;
   Collection_Finalization_Started : constant SFR.Finalizable_Ptr :=
                                       CFS'Access;
