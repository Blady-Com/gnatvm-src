...
private
   ...
   type RTS_Lock is new Interfaces.CIL.Object.Ref;
   ...
   type Suspension_Object is record
      ...
      CV : aliased Interfaces.CIL.Object.Ref;
      --  Condition variable used to queue threads until condition is signalled
   end record;

   type Private_Data is record
      Thread : Interfaces.CIL.Threading.Thread.Ref_Class;
