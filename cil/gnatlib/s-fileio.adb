...
--  This is the .NET/JVM version of this file
...
package body System.File_IO is
   ...
   function Errno_Message return String;
   ...
   function Errno_Message return String is
   begin
      return "";
   end Errno_Message;
   ...
   begin
      ...
      --  Normal case of Open or Create
         ...
         if Stream = NULL_Stream then
            ...
            Stream := fopen
              (Namestr'Address, Fopstr'Address, Encoding, Null_Address);
   ...
   begin
      ...
      raise Device_Error with Errno_Message;
   ...
   begin
      ...
      --  in the new mode and replacing the stream with a new stream.
         ...
         File.Stream := freopen
           (File.Name.all'Address, Fopstr'Address,
            File.Stream, File.Encoding, System.Null_Address);
