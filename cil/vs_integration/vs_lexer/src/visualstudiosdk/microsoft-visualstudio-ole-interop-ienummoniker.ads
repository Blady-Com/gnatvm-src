...
package Microsoft.VisualStudio.OLE.Interop.IEnumMoniker is
   ...
   procedure Clone
     (This : access Typ;
      ppEnum : access Microsoft.VisualStudio.OLE.Interop.IEnumMoniker.Ref) is abstract;
   function Next
     (This : access Typ;
      celt : CIL_Types.Unsigned_Integer;
      rgelt : access Microsoft.VisualStudio.OLE.Interop.IMoniker.Ref_arr;
...
end Microsoft.VisualStudio.OLE.Interop.IEnumMoniker;
pragma Import (CIL, Microsoft.VisualStudio.OLE.Interop.IEnumMoniker,
   ".ver 7:1:40304:0 .publickeytoken=( b0 3f 5f 7f 11 d5 0a 3a )",
   "[Microsoft.VisualStudio.OLE.Interop]Microsoft.VisualStudio.OLE.Interop.IEnumMoniker");
