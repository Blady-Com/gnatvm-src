...
namespace Microsoft.VisualStudio.Package.Automation
{
		...
		where T : HierarchyNode
    {
        ...
        public virtual EnvDTE.Project AddFromTemplate(string fileName, string destination, string projectName)
        {
            ...
            bool isVSTemplate = (String.Compare(targetExtension, ".vstemplate", StringComparison.OrdinalIgnoreCase) == 0)
                              || (String.Compare(targetExtension, ".vsz", StringComparison.OrdinalIgnoreCase) == 0);
