...
package JVM_File is
   ...
   Min_SUN_Minor_Version : constant U2 := 0;
   Min_SUN_Major_Version : constant U2 := 45;
   --  45.0 is the minimum version number supported in Java 1.5

   Max_SUN_Minor_Version : constant U2 := 0;
   Max_SUN_Major_Version : constant U2 := 49;
   --  49.0 is the maximum version number supported in Java 1.5
   ...
   --  Record modeling a JVM class file used for both classes and interfaces
      ...
      Minor_Version : U2 := Max_SUN_Minor_Version;
      Major_Version : U2 := Max_SUN_Major_Version;
      --  Minor/Major class file version as defined by SUN
   ...
   type Operation is (
      ...
      I2b, I2c, I2s,
      --  Convert 4 byte integer into 1 byte integer, 2 byte character or
...
private
   ...
   --  The following Inline pragmas are commented out because they lead
   --  to warnings with -gnatg/-gnatwa (due to nested subprograms).
   --  pragma Inline (Add);
