...
package body System.Text_IO is
   ...
   UARTDR : Unsigned_32;
   for UARTDR'Address use System'To_Address (16#4000_c000#);
   pragma Import (Ada, UARTDR);
   pragma Volatile (UARTDR);

   UARTFR : Unsigned_32;
   for UARTFR'Address use System'To_Address (16#4000_c018#);
   ...
   procedure Initialize is
      ...
      for UART0_IBRD'Address use System'To_Address (16#4000_c000# + 16#24#);
      pragma Import (Ada, UART0_IBRD);
      pragma Volatile (UART0_IBRD);

      UART0_FBRD : Unsigned_32;
      for UART0_FBRD'Address use System'To_Address (16#4000_c000# + 16#28#);
      pragma Import (Ada, UART0_FBRD);
      pragma Volatile (UART0_FBRD);

      UART0_LCRH : Unsigned_32;
      for UART0_LCRH'Address use System'To_Address (16#4000_c000# + 16#2c#);
      pragma Import (Ada, UART0_LCRH);
      pragma Volatile (UART0_LCRH);

      UART0_CTL : Unsigned_32;
      for UART0_CTL'Address use System'To_Address (16#4000_c000# + 16#30#);
