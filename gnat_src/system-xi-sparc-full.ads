...
private
   ...
   --  On bare board targets, the linking step requires special options to
   --  be passed to specify the linker script and libraries to be linked
   --  against. The following option specifies additional specs for the GCC
   --  driver that accomplish that.

   pragma Linker_Options ("--specs=leon.specs");
end System;
