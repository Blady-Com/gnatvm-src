...
package body System.Text_IO is
   ...
   for ESCI_CR2'Address use System'To_Address (16#Fffb_0000# + 4);
   pragma Import (Ada, ESCI_CR2);
   pragma Volatile (ESCI_CR2);

   ESCI_DR : Unsigned_16;
   for ESCI_DR'Address use System'To_Address (16#Fffb_0000# + 6);
   pragma Import (Ada, ESCI_DR);
   pragma Volatile (ESCI_DR);

   ESCI_SR : Unsigned_32;
   for ESCI_SR'Address use System'To_Address (16#Fffb_0000# + 8);
   ...
   for SIU_PCR89'Address use System'To_Address (16#c3f9_00f2#);
   pragma Import (Ada, SIU_PCR89);
   pragma Volatile (SIU_PCR89);

   SIU_PCR90 : Unsigned_16;
   for SIU_PCR90'Address use System'To_Address (16#c3f9_00f4#);
